...
@Composable
fun SFView(navController: NavController,id:Int){
    Scaffold(
        topBar = {
        ...
        ContentSFView(navController,id)
    }

}

@Composable
fun ContentSFView(navController: NavController,id: Int) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Column {
            Row(
                ...
                Image(
                    painter = painterResource(id = R.drawable.levi2),
            ...
            Row(
                ...
                Image(
                    painter = painterResource(id = R.drawable.sfsb),
                    contentDescription = "Imagen 3",
                    modifier = Modifier.size(150.dp),
                    contentScale = ContentScale.Crop
                )
                Image(
                    painter = painterResource(id = R.drawable.playsf),
        ...
        Text(
            text = "- Levi’s Stadium, ubicado en Santa Clara, California.",
            color = Color.White,
            fontSize = 16.sp
        )
        ...
        Text(
            text = "Joe Montana, Jerry Rice, Steve Young, Ronnie Lott.",
            color = Color.White,
            fontSize = 16.sp
        )
        Spacer(modifier = Modifier.height(16.dp))
        ...
        Text(
            text = "5 títulos: - 1982, 1985, 1989, 1990, 1995.",
            color = Color.White,
            fontSize = 16.sp
        )
        Spacer(modifier = Modifier.height(16.dp))
